...
public class T_131832_SGBV_Case_ID {
      ...
      /*************************Here we need to change the different values as per the test cases *************/
            ...
            driver.findElement(By.xpath("//*[@id='progres_nolinkentityfield_IMenu']//span[text()='Look Up More Records']/../../../..")).click();
                  ...
                  driver.switchTo().frame("contentIFrame0");
                  Thread.sleep(2000);
                  driver.findElement(By.xpath("//*[@id='progres_name']")).sendKeys("View name is SGBV Case ID"); 
