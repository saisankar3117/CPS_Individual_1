...
public class T_131832_Repatriation_Case_ID{
      ...
      /*************************In the below code we need to change the different values as per the test cases *************/
                  ...
                  driver.switchTo().frame("contentIFrame0");
                  Thread.sleep(2000);
                  driver.findElement(By.xpath("//*[@id='progres_name']")).sendKeys("View name is Repatriaton Case ID"); 
