package component_Creation;
	...
	public class T_131832_Local_Process_GUID {
	...
	/**/			.sendKeys("Local Process GUID");
				...
				driver.switchTo().frame("contentIFrame0");
				Thread.sleep(2000);
	/**/			driver.findElement(By.xpath("//*[@id='progres_nolinkview']"));
				Thread.sleep(2000);
				driver.switchTo().defaultContent();
				...
				driver.switchTo().frame("contentIFrame0");
				Thread.sleep(2000);
				driver.findElement(By.xpath("//*[@id='progres_name']"))
	              .sendKeys("Local_Process_GUID_Test"); 
	
		    	Thread.sleep(3000);
		    	driver.findElement(By.xpath("//*[@id='progres_idstoimport']")).sendKeys("No Data");
