...
public class T_131832_Resettlement_Case_ID{
      ...
      /*************************In the below code we need to change the different values as per the test cases *************/
                  
                  driver.findElement(By.xpath("//*[@id='crmGrid_findCriteria']"))
                              .sendKeys("Resettlement Case");
                  ...
                  Thread.sleep(2000);
                  driver.findElement(By.xpath("//div[@id='tblFind']//tr[2]//td[1]")).click();
                  Thread.sleep(1000);
                  ...
                  Thread.sleep(1000);
                  driver.findElement(By.xpath("//*[@id='crmGrid_findCriteria']"))
                        .sendKeys("Resettlement Case GUID");
                  ...
                  driver.switchTo().frame("contentIFrame0");
                  Thread.sleep(2000);
                  driver.findElement(By.xpath("//*[@id='progres_name']")).sendKeys("UNHCR"); 
